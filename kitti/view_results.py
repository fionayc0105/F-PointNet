...
def show_lidar_with_boxes(pc_velo, objects, calib,
    ...
    print("draw_lidar is finished.")


    for obj in objects:
        if obj.type == 'DontCare': continue
        print("Draw 3d bounding box, type=" + obj.type)
        ...
        mlab.text3d(box3d_pts_3d_velo[4, 0], box3d_pts_3d_velo[4, 1], box3d_pts_3d_velo[4, 2], '%s' % obj.type, figure=fig)
