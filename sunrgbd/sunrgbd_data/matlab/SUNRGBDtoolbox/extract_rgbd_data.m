...
%     end
    try
        ...
        data.depthpath(1:16) = '';
        data.depthpath = strcat('/home/fiona/ws/PointNet/frustum-pointnets/src/sunrgbd/sunrgbd_data/matlab',data.depthpath);
        data.rgbpath(1:16) = '';
        data.rgbpath = strcat('/home/fiona/ws/PointNet/frustum-pointnets/src/sunrgbd/sunrgbd_data/matlab',data.rgbpath);
