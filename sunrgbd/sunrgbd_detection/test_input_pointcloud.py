...
def get_pc_data(data_idx, type_whitelist=['bed', 'table', 'sofa', 'chair', 'toilet', 'desk', 'dresser', 'night_stand',
                                          'bookshelf', 'bathtub']):
    dataset = sunrgbd_object(
        '/home/fiona/ws/PointNet/frustum-pointnets/src/sunrgbd/sunrgbd_data/matlab/SUNRGBDtoolbox/mysunrgbd',
        'training')
    ...
    for obj_idx in range(len(objects)):
        ...
        # step2: calculate the frustum angle
...
def test_pointcloud():
    ...
    for batch_idx in range(num_batches):
        pc_list, onehot_list = get_pc_data(1 + batch_idx)
