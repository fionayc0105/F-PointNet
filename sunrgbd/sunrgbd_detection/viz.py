...
shuffled_keys = list(pred_map.keys())
...
for img_id in shuffled_keys:
    ...
    filename = os.path.join('/home/fiona/ws/PointNet/frustum-pointnets/src/sunrgbd/sunrgbd_detection/viz_results', '%06d.jpg' % (img_id))
